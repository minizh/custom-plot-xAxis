import { inject, provide, readonly, shallowRef, onScopeDispose, type App, type InjectionKey, type ShallowRef } from 'vue';
 ...
 */
export function provideMessageBus(options?: BusOptions): MessageBus<AppTopicMap> {
  const bus = new MessageBus<AppTopicMap>({ devLog: import.meta.env.DEV, ...options });
